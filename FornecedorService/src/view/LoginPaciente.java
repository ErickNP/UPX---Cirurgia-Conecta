...
public class LoginPaciente extends javax.swing.JFrame {
    ...
    public Paciente isAutenticado(String login, String senha){
        System.out.println("entrei");
        Paciente p = service.consultarP(login, senha);
        return p;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Paciente p = isAutenticado(login, senha);
        System.out.println(p);
        if(p != null){
            JformTelaPaciente ap = new JformTelaPaciente(p.getId());
